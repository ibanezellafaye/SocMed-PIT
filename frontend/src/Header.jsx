...
//           className={`relative py-2 px-4 text-white  hover:rounded-full ${theme === 'dark' ? 'bg-gray-800 text-white' : 'bg-white  text-black'}`}>
//           <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className={`size-7 active:fill-indigo-500 ${theme === 'dark' ? ' text-white fill-indigo-200 hover:fill-indigo-300' : ' fill-indigo-500 text-black hover:fill-indigo-700'}`}>
...
//         <button
//           onClick={toggleTheme}
//           className={`py-2 px-4  text-white ${theme === 'dark' ? ' text-white  bg-slate-200 hover:bg-slate-300 ' : 'bg-gray-800 text-black hover:bg-gray-900 '} rounded-full shadow-lg`}
//         >
...
const Header = ({ onLogout, toggleSidebar }) => {
  ...
  return (
    <div className={`fixed w-full flex items-center justify-between p-4 shadow-md z-30 ${theme === 'dark' ? 'bg-gray-800 text-white' : 'bg-white text-black'}`}>
