...
//                   className={`text-lg no-underline hover:underline font-semibold ${theme === 'dark' ? 'bg-gray-800 text-white' : 'bg-gray-100 text-gray-900'}`}
//                 >
//                   {user.first_name} {user.last_name}
//                 </button>
//                 <p className={`text-gray-600 ${theme === 'dark' ? 'bg-gray-800 text-gray-100' : 'bg-gray-100 text-gray-900'}`}>
//                   {user.email}
//                 </p>
//               </div>
//             </div>
...
//     <h1 className="text-base font-bold mt-8 mb-4">Followers ({followers.length})</h1>
//     {followers.length > 0 ? (
//       followers.map((user) => (
//         <div key={user.id} className={`mb-4 p-4 ${theme === 'dark' ? 'bg-gray-800' : 'bg-gray-100'} rounded-xl shadow-md`}>
//           <div className="flex items-center justify-between">
...
const Following = () => {
  ...
  return (
    <HelmetProvider>
      ...
      <div className={`min-h-screen p-6 ${theme === 'dark' ? 'bg-gray-900 text-white' : 'bg-white text-black'}`}>
        <div className="container mx-auto p-6">
          <h1 className="text-2xl font-bold mb-4 mt-20">Following Users ({following.length})</h1>
          {following.length > 0 ? (
            following.map((user) => (
              <div key={user.id} className={`mb-4 p-4 ${theme === 'dark' ? 'bg-gray-800' : 'bg-gray-100'} rounded-xl shadow-md`}>
                <div className="flex flex-col md:flex-row items-center justify-between">
