...
//         Swal.fire('Error', 'Failed to deactivate user account', 'error');
//     }
//   };
...
const AdminDashboard = () => {
  ...
  const handleActivate = async (userId) => {
    ...
    try {
      ...
      Swal.fire('Success', 'User account activated successfully', 'success');
      fetchUsers(); // Refresh the user list
    } catch (error) {
      console.error('Error activating user:', error);
      Swal.fire('Error', 'Failed to activate user account', 'error');
    }
  };
