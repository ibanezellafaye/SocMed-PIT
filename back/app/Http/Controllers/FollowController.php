...
class FollowController extends Controller
{
    ...
    {
        $user = Auth::user();
        $followedUser = User::where('id', $request->user_id)->where('status', 'active')->firstOrFail();
    ...
    {
        $user = Auth::user();
        $unfollowedUser = User::where('id', $request->user_id)->where('status', 'active')->firstOrFail();
    ...
    {
        $user = Auth::user();
        $following = $user->follows()->where('status', 'active')->pluck('followed_user_id');
    ...
    {
        $user = Auth::user();
        $followers = $user->followers()->where('status', 'active')->pluck('user_id');
